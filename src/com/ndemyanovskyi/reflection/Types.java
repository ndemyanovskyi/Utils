...
public final class Types {
     ...
     * {@code genericType} else {@code null} if no type arguments are declared
     */
    public static Class<?>[] resolveRawArguments(Type genericType, Class<?> subType) {
	Class<?>[] result = null;

	// Handle lambdas
	if(getConstantPoolMethod != null && subType.isSynthetic()) {
	...
	if(getConstantPoolMethod != null) {
		...
		for(Method m : functionalInterface.getMethods()) {
			...
			ConstantPool constantPool = (ConstantPool) getConstantPoolMethod.invoke(lambdaType);
